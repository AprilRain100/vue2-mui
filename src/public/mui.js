...
(
  function ($, window, name) {
    ...
    Toggle.prototype.init = function () {
      ...
      this.handleX = this.toggleWidth - this.handleWidth - 2;
    };
...
(
  function ($, window, document) {
    ...
    var createAlert = function (message, title, btnValue, callback, type) {
      var muiPopup = document.querySelector('.mui-popup');
      if (muiPopup) {
        return;
      }
      if (typeof message === 'undefined') {
...
(
  function ($, window, document) {
    ...
    Picker.prototype.setAngle = function (angle) {
      ...
      self.list.style.backfaceVisibility = "hidden";
      self.list.style.webkitBackfaceVisibility = "hidden";
      self.list.style.backfaceVisibility = "hidden";
      self.list.style.transform = "perspective(1000px) rotateY(0deg) rotateX(" + angle + "deg)";
      self.list.style.mozTransform = "perspective(1000px) rotateY(0deg) rotateX(" + angle + "deg)";
      self.list.style.oTransform = "perspective(1000px) rotateY(0deg) rotateX(" + angle + "deg)";
  ...
  function ($, document) {
    ...
    var panelBuffer = '<div class="mui-poppicker">\
		<div class="mui-poppicker-header" style="position: relative">\
			...
			<span style="display: inline-block;line-height: 28px;position: absolute;width: 160px;left: 50%;margin-left:	-80px;text-align: center;" class="mui-poppicker-title">标题</span>\
